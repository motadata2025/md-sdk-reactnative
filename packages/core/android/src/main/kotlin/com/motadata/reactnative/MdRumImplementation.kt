...
import com.motadata.android.rum.featureoperations.FailureReason
...
class MdRumImplementation(private val motadata: MotadataWrapper = MotadataSDKWrapper()) {
    /**
    ...
    fun startView(
        ...
        motadata.getRumMonitor().startView(
            key = key,
            name = name,
    ...
    fun stopView(key: String, context: ReadableMap, timestampMs: Double, promise: Promise) {
        ...
        motadata.getRumMonitor().stopView(
            key = key,
            attributes = attributes
        )
        promise.resolve(null)
    ...
    fun startAction(
        ...
        motadata.getRumMonitor().startAction(
    ...
    fun stopAction(
        ...
        motadata.getRumMonitor().stopAction(
            type = type.asRumActionType(),
            name = name,
            attributes = attributes
        )
    ...
    fun addAction(
        ...
        motadata.getRumMonitor().addAction(
            type = type.asRumActionType(),
            name = name,
            attributes = attributes
        )
    ...
    fun startResource(
        ...
        motadata.getRumMonitor().startResource(
            key = key,
    ...
    fun stopResource(
        ...
        motadata.getRumMonitor().stopResource(
            key = key,
    ...
    fun addError(
        ...
        motadata.getRumMonitor().addErrorWithStacktrace(
            message = message,
    ...
    fun addTiming(name: String, promise: Promise) {
        motadata.getRumMonitor().addTiming(name)
        promise.resolve(null)
    }
    ...
    fun addViewAttribute(key: String, value: ReadableMap, promise: Promise) {
        ...
        motadata.getRumMonitor().addViewAttributes(attributes)
        promise.resolve(null)
    }
    ...
    fun removeViewAttribute(key: String, promise: Promise) {
        ...
        motadata.getRumMonitor().removeViewAttributes(keysToDelete)
        promise.resolve(null)
    }
    ...
    fun addViewAttributes(attributes: ReadableMap, promise: Promise) {
        motadata.getRumMonitor().addViewAttributes(attributes.toMap())
        promise.resolve(null)
    }
    ...
    fun addViewLoadingTime(overwrite: Boolean, promise: Promise) {
        motadata.getRumMonitor().addViewLoadingTime(overwrite)
        promise.resolve(null)
    }
    ...
    fun stopSession(promise: Promise) {
        motadata.getRumMonitor().stopSession()
        promise.resolve(null)
    }
    ...
    fun addFeatureFlagEvaluation(name: String, valueAsMap: ReadableMap, promise: Promise) {
        ...
        if (value != null) {
            motadata.getRumMonitor().addFeatureFlagEvaluation(name, value)
        }
        promise.resolve(null)
    }
    ...
    fun startFeatureOperation(name: String, operationKey: String? = null, attributes: ReadableMap, promise: Promise) {
        ...
        motadata.getRumMonitor().startFeatureOperation(name, operationKey, attributesMap);
        promise.resolve(null)
    }
    ...
    fun succeedFeatureOperation(name: String, operationKey: String? = null, attributes: ReadableMap, promise: Promise) {
        val attributesMap = attributes.toHashMap().toMutableMap()
        motadata.getRumMonitor().succeedFeatureOperation(name, operationKey, attributesMap)
        promise.resolve(null)
    }
    ...
    fun failFeatureOperation(
        ...
        motadata.getRumMonitor().failFeatureOperation(name, operationKey, reason, attributesMap)
        promise.resolve(null)
    }
    ...
    private fun String.asRumResourceMethod(): RumResourceMethod {
        return when(lowercase(Locale.US)) {
            ...
            "connect" -> RumResourceMethod.CONNECT
                ...
                Log.w(
                    MdRum::class.java.canonicalName,
