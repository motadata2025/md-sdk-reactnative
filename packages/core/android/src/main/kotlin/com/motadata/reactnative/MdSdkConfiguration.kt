...
/**
 * A configuration object used to initialize Motadata's core SDK and its feature modules.
 *
 * @param additionalConfiguration Additional configuration parameters forwarded to the native Motadata SDK.
 * @param clientToken A valid Motadata client token.
 * @param env The application’s environment, for example: prod, pre-prod, staging, etc.
 * @param site The Motadata site of your organization (can be 'US', 'EU' or 'GOV', default is 'US').
 ...
 * @param configurationForTelemetry Additional configuration data for Motadata telemetry.
 */
data class MdSdkConfiguration(
...
/**
 * A configuration object for the Motadata RUM feature.
 *
 ...
 * @param customEndpoint Custom RUM intake endpoint used to override the default Motadata intake.
 */
...
/**
 * A configuration object for Motadata Traces (APM) features.
 *
 * @param customEndpoint Custom Trace intake endpoint used to override the default Motadata intake.
 */
...
internal data class JSONConfigurationFile(
    val configuration: JSONMdSdkConfiguration
)

internal data class JSONMdSdkConfiguration(
    val clientToken: String,
    val env: String,
    val trackingConsent: String? = null,
    val additionalConfiguration: Map<String, Any?>? = null,
...
/**
 * Additional configuration data for Motadata telemetry.
