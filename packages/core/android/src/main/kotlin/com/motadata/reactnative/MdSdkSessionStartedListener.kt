...
internal class MdSdkSessionStartedListener private constructor() : RumSessionListener {
    companion object {
        // JS-side callable module registered via BatchedBridge.registerCallableModule.
        private const val BRIDGE_MODULE_NAME = "MotadataInternalReactBridge"
        private const val BRIDGE_MODULE_METHOD = "__motadataOnMessageReceived"

        private var instance: MdSdkSessionStartedListener? = null
        ...
        fun getInstance(): MdSdkSessionStartedListener {
            if (instance == null) {
                instance = MdSdkSessionStartedListener()
            }
            return instance!!
        }
    ...
    //   - MdSdk#onHostResume (both architectures) via the lifecycle listener
    //   - MdSdkImplementation#initialize (new-arch race fix — the TurboModule is lazy-
    ...
    // SDK was already running. At this point MotadataInternalReactBridge is guaranteed to
