...
internal fun ReadableMap.asMdSdkConfiguration(): MdSdkConfiguration {
...
@Suppress("CyclomaticComplexMethod")
internal fun JSONMdSdkConfiguration.asMdSdkConfiguration(): MdSdkConfiguration {
...
internal fun List<JSONFirstPartyHost>.asFirstPartyHosts(): Map<String, Set<TracingHeaderType>> {
     ...
     *
     * RN config: [{ match: "example.com", propagatorTypes: [MOTADATA, B3] }] Android config: {
     * "example.com": [MOTADATA, B3] }
     */
...
internal fun MdSdkConfiguration.toReadableMap(): ReadableMap {
