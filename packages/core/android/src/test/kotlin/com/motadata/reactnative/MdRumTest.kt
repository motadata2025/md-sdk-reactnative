...
internal class MdRumTest {
    ...
    fun `set up`(forge: Forge) {
        ...
        testedMdRum = MdRumImplementation(mockMotadata)
    }
    ...
    fun `M call startView W startView()`(
        ...
        // When
        testedMdRum.startView(key, name, fakeContext.toReadableMap(), fakeTimestamp, mockPromise)
    ...
    fun `M call stopView W stopView()`(
        ...
        // When
        testedMdRum.stopView(key, fakeContext.toReadableMap(), fakeTimestamp, mockPromise)
    ...
    fun `M call startAction W startAction() with invalid type`(
        ...
        // When
        testedMdRum.startAction(type, name, fakeContext.toReadableMap(), fakeTimestamp, mockPromise)
    ...
    fun `M call stopAction W stopAction() with invalid type`(
        ...
        // When
        testedMdRum.stopAction(type, name, fakeContext.toReadableMap(), fakeTimestamp, mockPromise)
    ...
    fun `M call addTiming W addTiming()`(@StringForgery timing: String) {
        // When
        testedMdRum.addTiming(timing, mockPromise)
    ...
    fun `M call addViewAttribute W addViewAttribute()`(
        ...
        // When
        testedMdRum.addViewAttribute(key, attributeMap.toReadableMap(), mockPromise)
    ...
    fun `M call removeViewAttribute W removeViewAttribute()`(@StringForgery key: String) {
        // When
        testedMdRum.removeViewAttribute(key, mockPromise)
    ...
    fun `M call addViewAttributes W addViewAttributes()`(
        ...
        // When
        testedMdRum.addViewAttributes(customAttributes.toReadableMap(), mockPromise)
    ...
    fun `𝕄 call removeViewAttributes 𝕎 removeViewAttributes`(
        ...
        // When
        testedMdRum.removeViewAttributes(customAttributes.keys.toReadableArray(), mockPromise)
    ...
    fun `M call addViewLoadingTime w addViewLoadingTime()`(@BoolForgery overwrite: Boolean) {
        // When
        testedMdRum.addViewLoadingTime(overwrite, mockPromise)
    ...
    fun `M call stopSession W stopSession()`() {
        // When
        testedMdRum.stopSession(mockPromise)
    ...
    fun `M call addFeatureFlagEvaluation W addFeatureFlagEvaluation(boolean value)`(
        ...
        // When
        testedMdRum.addFeatureFlagEvaluation(name, valueAsReadableMap.toReadableMap(), mockPromise)
