...
import com.motadata.tools.unit.GenericAssert.Companion.assertThat
import com.motadata.tools.unit.MockRumMonitor
import com.motadata.tools.unit.TestJsThreadExecutor
import com.motadata.tools.unit.TestUiThreadExecutor
import com.motadata.tools.unit.forge.BaseConfigurator
import com.motadata.tools.unit.setStaticValue
import com.motadata.tools.unit.toReadableArray
import com.motadata.tools.unit.toReadableJavaOnlyMap
import com.motadata.tools.unit.toReadableMap
...
internal class MdSdkTest {
    lateinit var testedBridgeSdk: MdSdkImplementation
    ...
    @Mock
    lateinit var mockMotadata: MotadataWrapper

    @Mock
    lateinit var mockMdTelemetry: MdTelemetry

    @Forgery
    lateinit var fakeConfiguration: MdSdkConfiguration
    ...
    fun `set up`() {
        ...
        whenever(mockMotadata.getRumMonitor()) doReturn mockRumMonitor
        ...
        testedBridgeSdk = MdSdkImplementation(
            mockReactContext,
            mockMotadata,
            mockMdTelemetry,
        ...
        MotadataSDKWrapperStorage.onInitializedListeners.clear()
    }
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {nativeCrashReportEnabled=true}`() {
        ...
        try {
            ...
            // Then
            inOrder(mockMotadata) {
                verify(mockMotadata).initialize(
                    same(mockContext),
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {needsClearTextHttp=true}`() {
        ...
        val additionalConfig = (
            ...
            ).also { it[MdSdkImplementation.MD_NEEDS_CLEAR_TEXT_HTTP] = true }
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", MotadataSite.US1)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", MotadataSite.US3)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", MotadataSite.US5)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", MotadataSite.US1_FED)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", MotadataSite.US2_FED)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", MotadataSite.EU1)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", MotadataSite.AP1)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasField("coreConfig") {
                    it.hasFieldEqualTo("needsClearTextHttp", false)
                    it.hasFieldEqualTo("firstPartyHostsWithHeaderTypes", emptyMap<String, String>())
                    it.hasFieldEqualTo("site", MotadataSite.AP2)
                }
                .hasFieldEqualTo("clientToken", fakeConfiguration.clientToken)
                .hasFieldEqualTo("env", fakeConfiguration.env)
                .hasFieldEqualTo("variant", "")
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {no view tracking}`(
        @Forgery configuration: MdSdkConfiguration
    ) {
        // Given
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {sdk verbosity}`(
        ...
        // Then
        verify(mockMotadata).setVerbosity(verbosity)
    }
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {invalid sdk verbosity}`(
        ...
        // Then
        verify(mockMotadata, never()).setVerbosity(any())
    }
                ...
                .hasField("featureConfiguration") { rumConfig ->
                    rumConfig.hasField("longTaskTrackingStrategy") { longTaskTrackingStrategy ->
                        longTaskTrackingStrategy
                            .isInstanceOf(
                                "com.motadata.android.rum.internal.instrumentation." +
    ...
    fun `𝕄 set first party hosts 𝕎 initialize() {duplicated first party hosts}`(
        ...
        firstPartyHosts.add(
            mapOf(
                "match" to host,
                "propagatorTypes" to listOf(
                    TracingHeaderType.B3MULTI.name.lowercase(Locale.US)
                ).toReadableArray()
            ).toReadableMap()
        )
        firstPartyHosts.add(
    ...
    fun `𝕄 set version 𝕎 initialize() {versionSuffix}`(
        ...
        val bridgeConfiguration = configuration.copy(
            additionalConfiguration = mapOf(
                MdSdkImplementation.MD_VERSION_SUFFIX to versionSuffix
            )
        )
        val sdkConfigCaptor = argumentCaptor<Configuration>()
        val rumConfigCaptor = argumentCaptor<RumConfiguration>()
        ...
        try {
            ...
            assertThat(sdkConfigCaptor.firstValue)
                .hasFieldEqualTo(
                    ...
                    mapOf(
                        MdSdkImplementation.MD_VERSION_SUFFIX to versionSuffix,
                        MdSdkImplementation.MD_VERSION to (
    ...
    fun `𝕄 clear user info 𝕎 clearUserInfo()`() {
        ...
        // Then
        argumentCaptor<Map<String, Any?>> {
            verify(mockMotadata).clearUserInfo()
        }
    }
    ...
    fun `M set Rum attribute W addAttribute`(
        ...
        // Then
        verify(mockMotadata).addRumGlobalAttribute(key, value)
    }
    ...
    fun `M remove Rum attribute W removeAttribute`(
        ...
        // Then
        verify(mockMotadata).removeRumGlobalAttribute(key)
    }
    ...
    fun `𝕄 set RUM attributes 𝕎 addAttributes`(
        ...
        // Then
        verify(mockMotadata).addRumGlobalAttributes(customAttributes)
    }
    ...
    fun `𝕄 remove RUM attributes 𝕎 removeAttributes`(
        ...
        // Then
        verify(mockMotadata).removeRumGlobalAttributes(customAttributes.keys.toTypedArray())
    }
    ...
    fun `𝕄 call setTrackingConsent 𝕎 setTrackingConsent ()`(forge: Forge) {
        ...
        // Then
        verify(mockMotadata).setTrackingConsent(consent.asTrackingConsent())
    }
    ...
    fun `𝕄 initialize native SDK 𝕎 initialize() {synthethics attributes}`() {
        ...
        fakeConfiguration = fakeConfiguration.copy(site = null, rumConfiguration = rumConfiguration)
        MdSdkSynthetics.testId = "unit-test-test-id"
        MdSdkSynthetics.resultId = "unit-test-result-id"
