...
) : NativeMdRumSpec(reactContext) {

    private val implementation = MdRumImplementation(motadata = motadataWrapper)

    override fun getName(): String = MdRumImplementation.NAME
