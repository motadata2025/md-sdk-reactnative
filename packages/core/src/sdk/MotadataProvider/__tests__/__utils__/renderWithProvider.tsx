...
import { MotadataProvider } from '../../MotadataProvider';
...
export const getDefaultConfiguration = () => {
    const defaultConfiguration = new MotadataProviderConfiguration(
        'fakeToken',
        'fakeEnv'
    );
...
export const renderWithProvider = (params?: {
    ...
    const rerenderWithRandomConfig = () => {
        const randomConfiguration = new MotadataProviderConfiguration(
        ...
        result.rerender(
            <MotadataProvider configuration={randomConfiguration}>
                {AppComponent}
            </MotadataProvider>
        );
    };
