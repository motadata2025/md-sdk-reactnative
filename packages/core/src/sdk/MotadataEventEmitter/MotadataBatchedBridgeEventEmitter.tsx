...
import type {
    MotadataEventEmitterCallback,
    MotadataEventEmitter
} from './MotadataEventEmitter';

export class MotadataBatchedBridgeEventEmitter implements MotadataEventEmitter {
    private listeners: Record<string, MotadataEventEmitterCallback>;
    ...
    __motadataOnMessageReceived(eventName: string, data: any): void {
