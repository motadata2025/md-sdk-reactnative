...
const BABEL_INTERACTION_TRACKING_MODULE =
    'com.motadata.reactnative.rum.babel_interaction_tracking';
...
class BabelInteractionTracking {
    ...
    private ddRum: typeof MdRum | null = null;

    isInitialized: boolean = false;

    getInstance() {
        return MdBabelInteractionTracking;
    }

    attachRumInstance(ddRum: typeof MdRum) {
        this.ddRum = ddRum;
    ...
    getTelemetryConfig() {
        return {
            babel_plugin: {
                enabled: !!globalThis.__MD_RN_BABEL_PLUGIN_ENABLED__,
...
export const MdBabelInteractionTracking = getGlobalInstance(
