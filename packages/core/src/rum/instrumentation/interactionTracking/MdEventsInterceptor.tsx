...
const MD_ACTION_NAME_PROP = 'dd-action-name';

export type MdEventsInterceptorOptions = {
    /**
...
export class MdEventsInterceptor implements EventsInterceptor {
    ...
    constructor(options: MdEventsInterceptorOptions = {}) {
    ...
    private findClosestActionLabel(targetNode: any): string | null {
        ...
        while (currentNode) {
            ...
            if (props && props[MD_ACTION_NAME_PROP]) {
                return props[MD_ACTION_NAME_PROP];
            }
            if (
