...
import { MotadataTracingIdentifier } from './MotadataTracingIdentifier';
 ...
 * for RUM Resources.
 */
export class MotadataTracingContext {
    ...
    readonly traceId?: MotadataTracingIdentifier;
    readonly spanId?: MotadataTracingIdentifier;
