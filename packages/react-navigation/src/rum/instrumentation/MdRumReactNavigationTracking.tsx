...
const REACT_NAVIGATION_TRACKING_MODULE =
    'com.motadata.reactnative.rum.react_navigation_tracking';
...
class RumReactNavigationTracking {
    ...
    readonly NAVIGATION_REF_IN_USE_ERROR_MESSAGE =
        'Cannot track new navigation container while another one is still tracked. Please call `MdRumReactNavigationTracking.stopTrackingViews` on the previous container reference.';
    ...
    stopTrackingViews(navigationRef: NavigationContainerRef | null): void {
        ...
        if (this.appStateSubscription) {
            ...
            // see the upstream issue about calling stopTrackingViews before startTrackingViews
        ...
        if (key != null && screenName != null) {
            ...
            if (appStateStatus !== 'background') {
                ...
                if (this.viewTrackingPredicate(route)) {
                    ...
                    if (params) {
                        MdRum.startView(customKey, screenName, { params });
                    } else {
                        MdRum.startView(customKey, screenName);
                    }
                }
            }
        }
...
export const MdRumReactNavigationTracking = getGlobalInstance(
